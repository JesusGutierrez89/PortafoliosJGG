        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_300px] lg:gap-12 xl:grid-cols-[1fr_400px]">
          <div className="flex flex-col justify-center space-y-6 order-2 lg:order-1">
            <div className="space-y-4 text-center lg:text-left">
              ...
              <p className="text-xl sm:text-2xl text-muted-foreground font-headline">{t.hero.subtitle}</p>
              {t.hero.description && (
            ...
            <div className="flex items-center justify-center lg:justify-start gap-6 pt-4">
              <Link
                href="mailto:jesusgutierrezgarcia1989@gmail.com"
                className="text-muted-foreground transition-colors hover:text-foreground hover:scale-110 transform"
              >
                <Mail className="h-6 w-6" />
                <span className="sr-only">Email</span>
              </Link>
              <Link
                href="https://github.com/JesusGutierrez89"
                target="_blank"
                className="text-muted-foreground transition-colors hover:text-foreground hover:scale-110 transform"
              >
              ...
              <Link
                href="https://linkedin.com/in/jesús-gutiérrez-garcía-83961a366"
                target="_blank"
                className="text-muted-foreground transition-colors hover:text-foreground hover:scale-110 transform"
              >
