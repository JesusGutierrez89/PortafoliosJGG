...
const skills: {
  ...
  { name: "Angular", icon: <Component className="h-8 w-8 text-primary" />, knowledge: "medio", experience: "<6 meses" },
  ...
  { name: "Hexagonal", icon: <Network className="h-8 w-8 text-primary" />, knowledge: "medio", experience: "<6 meses" },
